...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <form action="{{ route('admin.edi.car.store') }}" method="POST" enctype="multipart/form-data" id="car-form">
            @csrf
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="driver_name_1" id="driver_name_1" class="form-control">
                    @error('driver_name_1')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="driver_name_2" id="driver_name_2" class="form-control">
                    @error('driver_name_2')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
